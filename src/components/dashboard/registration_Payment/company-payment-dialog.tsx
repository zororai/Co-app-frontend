...
export interface CompanyPaymentDialogProps {
  open: boolean;
  onClose: () => void;
...
export default function CompanyPaymentDialog({ open, onClose, companyId, onSuccess }: CompanyPaymentDialogProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await authClient.putCompanyPayment(companyId, payload);
      if (!res.success) {
