            ...
            {filteredRows.map((row) => {
              ...
              return (
                <TableRow hover key={row.id} selected={isSelected}>
                  ...
                  <TableCell sx={{ backgroundColor: '#ffffcc' }}>{row.goldSales && row.goldSales[0] ? row.goldSales[0].weight : ''}</TableCell>
                  <TableCell sx={{ backgroundColor: '#ffffcc' }}>{row.goldSales && row.goldSales[0] ? row.goldSales[0].price : ''}</TableCell>
                  <TableCell sx={{ backgroundColor: '#ffffcc' }}>{row.goldSales && row.goldSales[0] ? row.goldSales[0].buyer : ''}</TableCell>
