    ...
    <Card>      
            ...
            {filteredRows.map((row) => {
              ...
              return (
                <TableRow hover key={row.id} selected={isSelected}>
                  ...
                  <TableCell>{row.millName || 'N/A'}</TableCell>
                  <TableCell>{row.millLocation || 'N/A'}</TableCell>
                  <TableCell>{row.millType || 'N/A'}</TableCell>
                  <TableCell>{row.owner || 'N/A'}</TableCell>
                  <TableCell>{row.idNumber || 'N/A'}</TableCell>
      ...
      {isDriverDetailsDialogOpen && (
        <MillDetailsDialog
          ...
          onActionComplete={refreshTableData}
        />
      )}
