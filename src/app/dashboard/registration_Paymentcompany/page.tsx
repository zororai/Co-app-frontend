...
import { RegMinerDialog } from '@/components/dashboard/registration_Payment/regcompany_miner';
import { authClient } from '@/lib/auth/client';
import { Company, CompanyTable } from '@/components/dashboard/registration_Payment/company-table';
