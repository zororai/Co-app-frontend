...
import { CustomersTable } from '@/components/dashboard/oreTransport/oreTransport-table';
import type { Customer } from '@/components/dashboard/oreTransport/oreTransport-table';
...
export default function Page(): React.JSX.Element {
  ...
  const handleExport = (format: 'csv' | 'pdf') => {
    ...
    if (format === 'csv') {
      ...
      a.href = url;
      a.download = `ore-transport-${tab.toLowerCase()}-${timestamp}.csv`;
      ...
      const doc = new jsPDF();
      doc.setFontSize(20);
      doc.text(`Ore Transport - ${tab}`, 14, 22);
      doc.setFontSize(12);
      ...
      doc.save(`ore-transport-${tab.toLowerCase()}-${timestamp}.pdf`);
    }
  };
