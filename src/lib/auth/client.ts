...
class AuthClient {
    ...
    async fetchApprovedProductionLoans(): Promise<any[]> {
        ...
        try {
            const response = await fetch('https://coappapi.commapp.online/api/production-loan/approved', {
                method: 'GET',
                headers: {
                    Accept: '*/*',
                    Authorization: `Bearer ${token}`,
    ...
    async fetchSectionsApproved(): Promise<any[]> {
        ...
        try {
            const response = await fetch('https://coappapi.commapp.online/api/sections/status/approved', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async createOre(oreData: {
        ...
        try {
            ...
            const response = await fetch('https://coappapi.commapp.online/api/ore-transports/create', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': '*/*',
    ...
    async registerSecurityCompany(securityCompanyData: {
        ...
        try {
            const response = await fetch('https://coappapi.commapp.online/api/security-companies/register', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': '*/*',
    ...
    async fetchDriverById(driverId: string): Promise<any> {
        ...
        try {
            const response = await fetch(`https://coappapi.commapp.online/api/drivers/${driverId}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': '*/*',
    ...
    async fetchMillById(driverId: string): Promise<any> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/mill-onboarding/${driverId}`, {
              method: 'GET',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': '*/*',
  ...
  async approveMill(millId: string): Promise<{ success: boolean; error?: string }> {
      ...
      try {
          ...
          const response = await fetch(`https://coappapi.commapp.online/api/mill-onboarding/${millId}/approve`, {
              method: 'PUT',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': 'application/json',
  ...
  async rejectMill(millId: string, reason: string): Promise<{ success: boolean; error?: string }> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/mill-onboarding/${millId}/reject?reason=${encodeURIComponent(reason)}`, {
              method: 'PUT',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': 'application/json',
  ...
  async pushbackMill(millId: string, reason: string): Promise<{ success: boolean; error?: string }> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/mill-onboarding/${millId}/pushback?reason=${encodeURIComponent(reason)}`, {
              method: 'PUT',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': 'application/json',
  ...
  async fetchLoansByShaftNumber(shaftNumber: string): Promise<any> {
      ...
      try {
          ...
          const url = `https://coappapi.commapp.online/api/shaft-assignments/by-shaft-number/${safeShaft}/loans`;
  ...
  async fetchShaftAssignmentsByMiner(minerId: string | number): Promise<any[]> {
      ...
      try {
          ...
          const url = `https://coappapi.commapp.online/api/shaft-assignments/by-miner/${safeId}`;
          const response = await fetch(url, {
              method: 'GET',
              headers: {
                  'Accept': '*/*',
  ...
  async approveShaftLoan(assignmentId: string): Promise<{ success: boolean; error?: string }> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/shaft-assignments/${assignmentId}/loan/approve`, {
              method: 'PUT',
              headers: {
                  'Accept': '*/*',
                  'Authorization': `Bearer ${token}`,
  ...
  async rejectShaftLoan(assignmentId: string, reason?: string): Promise<{ success: boolean; error?: string }> {
      ...
      try {
          const url = new URL(`https://coappapi.commapp.online/api/shaft-assignments/${assignmentId}/loan/reject`);
  ...
  async pushBackShaftLoan(assignmentId: string, reason?: string): Promise<{ success: boolean; error?: string }> {
      ...
      try {
          const url = new URL(`https://coappapi.commapp.online/api/shaft-assignments/${assignmentId}/loan/pushback`);
          if (reason) url.searchParams.set('reason', reason);
          const response = await fetch(url.toString(), {
              method: 'PUT',
              headers: {
    ...
    async fetchSecurityCompany(): Promise<any[]> {
        ...
        try {
            const response = await fetch('https://coappapi.commapp.online/api/security-companies', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async fetchOreTransportData(): Promise<any[]> {
      ...
      try {
          const response = await fetch('https://coappapi.commapp.online/api/ore-transports/allOre', {
              method: 'GET',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': 'application/json',
  ...
  async fetchOretaxData(): Promise<any[]> {
    ...
    try {
        const response = await fetch('https://coappapi.commapp.online/api/ore-transports/with-selected-transportdriver-changed', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
...
async fetchOreDispatcher(): Promise<any[]> {
  ...
  try {
      const response = await fetch('https://coappapi.commapp.online/api/ore-transports/security-dispatcher/not-specified', {
          method: 'GET',
          headers: {
              'Content-Type': 'application/json',
              'Accept': 'application/json',
...
async fetchOreRecieve(): Promise<any[]> {
  ...
  try {
      const response = await fetch('https://coappapi.commapp.online/api/ore-transports/security-dispatcher/received', {
          method: 'GET',
          headers: {
              'Content-Type': 'application/json',
              'Accept': 'application/json',
...
async fetchOreRecieved(): Promise<any[]> {
  ...
  try {
      const response = await fetch('https://coappapi.commapp.online/api/ore-transports/security-dispatcher/dispatched', {
          method: 'GET',
          headers: {
              'Content-Type': 'application/json',
              'Accept': 'application/json',
  ...
  async fetchtax(): Promise<any[]> {
    ...
    try {
        const response = await fetch('https://coappapi.commapp.online/api/taxdidections', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
  ...
  async fetchApprovedTaxDirections(): Promise<any[]> {
    ...
    try {
        const response = await fetch('https://coappapi.commapp.online/api/taxdidections/approved', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Accept': '*/*',
  ...
  async fetchUsers(): Promise<any[]> {
    ...
    try {
        const response = await fetch('https://coappapi.commapp.online/api/users', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
    ...
    async fetchProductionDetails(customerId: string): Promise<any> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/production-loan/${customerId}`, {
              method: 'GET',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': 'application/json',
  ...
  async fetchProductionData(): Promise<any[]> {
      ...
      try {
          const response = await fetch('https://coappapi.commapp.online/api/production-loan/all', {
              method: 'GET',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': 'application/json',
  ...
  async createProductionLoan(loanData: any): Promise<any> {
      ...
      try {
          const response = await fetch('https://coappapi.commapp.online/api/production-loan/create', {
              method: 'POST',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': 'application/json',
  ...
  async approveProductionLoan(loanId: string): Promise<{ success: boolean; error?: string }> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/production-loan/${loanId}/approve`, {
              method: 'PUT',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': '*/*',
  ...
  async rejectProductionLoan(loanId: string, reason: string): Promise<{ success: boolean; error?: string }> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/production-loan/${loanId}/reject?reason=${encodeURIComponent(reason)}`, {
              method: 'PUT',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': '*/*',
  ...
  async pushbackProductionLoan(loanId: string, reason: string): Promise<{ success: boolean; error?: string }> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/production-loan/${loanId}/push-back?reason=${encodeURIComponent(reason)}`, {
              method: 'PUT',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': '*/*',
    ...
    async fetchUserById(userId: string): Promise<any> {
        ...
        try {
            const response = await fetch(`https://coappapi.commapp.online/api/users/${userId}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async approveUser(userId: string): Promise<{ success: boolean; error?: string }> {
        ...
        try {
            const response = await fetch(`https://coappapi.commapp.online/api/users/${userId}/approve`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async approveTax(userId: string): Promise<{ success: boolean; error?: string }> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/taxdidections/${userId}/approve`, {
              method: 'PUT',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': 'application/json',
  ...
  async fetchActivatedMills(): Promise<any[]> {
      ...
      try {
          const response = await fetch('https://coappapi.commapp.online/api/mill-onboarding/activated', {
              method: 'GET',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': '*/*',
    ...
    async rejectUser(userId: string, reason: string): Promise<{ success: boolean; error?: string }> {
        ...
        try {
            const response = await fetch(`https://coappapi.commapp.online/api/users/${userId}/reject?reason=${encodeURIComponent(reason)}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async pushtax(userId: string, reason: string): Promise<{ success: boolean; error?: string }> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/taxdidections/${userId}/pushback?reason=${encodeURIComponent(reason)}`, {
              method: 'PUT',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': 'application/json',
    ...
    async rejectTax(userId: string, reason: string): Promise<{ success: boolean; error?: string }> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/taxdidections/${userId}/reject?reason=${encodeURIComponent(reason)}`, {
              method: 'PUT',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': 'application/json',
    ...
    async pushbackUser(userId: string, reason: string): Promise<{ success: boolean; error?: string }> {
        ...
        try {
            const response = await fetch(`https://coappapi.commapp.online/api/users/${userId}/pushback?reason=${encodeURIComponent(reason)}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async registerMill(millData: {
        ...
        try {
            const response = await fetch('https://coappapi.commapp.online/api/mill-onboarding/create', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': '*/*',
    ...
    async fetchSections(): Promise<any[]> {
        ...
        try {
            const response = await fetch('https://coappapi.commapp.online/api/sections', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async fetchAllMiners(): Promise<Customer[]> {
        ...
        try {
            const response = await fetch('https://coappapi.commapp.online/api/sections/miners', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
  ...
  async fetchapprovedshaft(): Promise<any[]> {
    ...
    try {
      const response = await fetch('https://coappapi.commapp.online/api/shaft-assignments/approved', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Accept': '*/*',
  ...
  async fetchDrivers(): Promise<any[]> {
    ...
    try {
      const response = await fetch('https://coappapi.commapp.online/api/drivers', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Accept': '*/*',
  ...
  async fetchMill(): Promise<any[]> {
    ...
    try {
      const response = await fetch('https://coappapi.commapp.online/api/mill-onboarding/all', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Accept': '*/*',
  ...
  try {
    const response = await fetch(`https://coappapi.commapp.online/api/drivers/${driverId}/approve`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Accept': '*/*',
...
async applyTax(oreId: string): Promise<{ success: boolean; data?: any; error?: string }> {
  ...
  try {
    const response = await fetch(`https://coappapi.commapp.online/api/ore-transports/${oreId}/apply-tax`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Accept': '*/*',
  ...
  async rejectDriver(driverId: string, reason: string): Promise<{ success: boolean; error?: string }> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/drivers/${driverId}/reject?reason=${encodeURIComponent(reason)}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': '*/*',
  ...
  async pushbackDriver(driverId: string, reason: string): Promise<{ success: boolean; error?: string }> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/drivers/${driverId}/pushback?reason=${encodeURIComponent(reason)}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': '*/*',
    ...
    async fetchCompanyById(id: string): Promise<any> {
        ...
        try {
            const response = await fetch(`https://coappapi.commapp.online/api/companies/${id}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': '*/*',
    ...
    async setMinerForApproval(id: string): Promise<any> {
        ...
        try {
            const response = await fetch(`https://coappapi.commapp.online/api/miners/${id}/set_for_approval`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async setCompanyMinerForApproval(id: string): Promise<any> {
        ...
        try {
            const response = await fetch(`https://coappapi.commapp.online/api/companies/${id}/approve`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async setMinerForRejection(id: string, reason: string): Promise<any> {
        ...
        try {
            ...
            const response = await fetch(`https://coappapi.commapp.online/api/miners/${id}/reject?reason=${encodeURIComponent(reason)}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async setCompanyMinerForRejection(id: string, reason: string): Promise<any> {
        ...
        try {
            // Using the new API endpoint format with reason as a query parameter
            const response = await fetch(`https://coappapi.commapp.online/api/companies/${id}/reject?reason=${encodeURIComponent(reason)}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async setMinerForPushBack(id: string, reason: string): Promise<any> {
        ...
        try {
            // Using the new API endpoint format with reason as a query parameter
            const response = await fetch(`https://coappapi.commapp.online/api/miners/${id}/pushback?reason=${encodeURIComponent(reason)}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async setCompanyMinerForPushBack(id: string, reason: string): Promise<any> {
        ...
        try {
            // Using the new API endpoint format with reason as a query parameter
            const response = await fetch(`https://coappapi.commapp.online/api/companies/${id}/pushback?reason=${encodeURIComponent(reason)}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    /**
     * Fetch companies from the endpoint https://coappapi.commapp.online/api/companies
    ...
    async fetchCompaniesFromEndpoint(): Promise<any[]> {
        ...
        try {
            const response = await fetch('https://coappapi.commapp.online/api/companies', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async fetchCompaniesApproved(): Promise<any[]> {
        ...
        try {
            const response = await fetch('https://coappapi.commapp.online/api/companies/status/approved', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async registerCompany(formData: any): Promise<{ error?: string; success?: boolean }> {
        try {
            ...
            const response = await fetch('https://coappapi.commapp.online/api/companies/register', {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Accept': 'application/json',
 ...
 async signInWithPassword(params: SignInWithPasswordParams): Promise<{ error?: string; token?: string }> {
  ...
  try {
    const response = await fetch('https://coappapi.commapp.online/auth/signin', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Accept': 'application/json',
    ...
    async fetchCompanies(): Promise<any[]> {
        ...
        try {
            const response = await fetch('https://coappapi.commapp.online/api/companies/getall', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async fetchProductionloanDetails(id: string): Promise<any> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/production-loan/${id}`, {
              method: 'GET',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': 'application/json',
    ...
    async fetchOreDetails(id: string): Promise<any> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/ore-transports/${id}`, {
              method: 'GET',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': 'application/json',
  ...
  async fetchSecurityDetails(id: string): Promise<any> {
    ...
    try {
        const response = await fetch(`https://coappapi.commapp.online/api/security-companies/${id}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
    ...
    async fetchTaxDetails(id: string): Promise<any> {
      ...
      try {
          const response = await fetch(`https://coappapi.commapp.online/api/taxdidections/${id}`, {
              method: 'GET',
              headers: {
                  'Content-Type': 'application/json',
                  'Accept': 'application/json',
    ...
    async fetchCustomerDetails(id: string): Promise<any> {
        ...
        try {
            const response = await fetch(`https://coappapi.commapp.online/api/miners/${id}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async fetchCustomers(): Promise<Customer[]> {
        ...
        try {
            const response = await fetch('https://coappapi.commapp.online/api/miners/getall', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async fetchShaftstatus(): Promise<Customer[]> {
        ...
        try {
            const response = await fetch('https://coappapi.commapp.online/api/shaft-assignments', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async updateShaftLoanDetails(
        ...
        try {
            ...
            const url = `https://coappapi.commapp.online/api/shaft-assignments/${encodeURIComponent(assignmentId)}/update-loan-details?${qs.toString()}`;
            const response = await fetch(url, {
                method: 'PUT',
                headers: {
                    Accept: '*/*',
     ...
     async fetchApprovedminer(): Promise<Customer[]> {
        ...
        try {
            const response = await fetch('https://coappapi.commapp.online/api/miners/getapproved', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
...
cooperativename: string;
    ...
    try {
      ...
      const response = await fetch('https://coappapi.commapp.online/api/miners/createminers', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  async createSection(sectionData: {
    ...
    try {
      const response = await fetch('https://coappapi.commapp.online/api/sections/create', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async setShaftForApproval(id: string): Promise<any> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/shaft-assignments/${id}/approve`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async setSectionForApproval(id: string): Promise<any> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/sections/${id}/approve`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async approveVehicle(id: string): Promise<any> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/vehicles/${id}/approve`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async setSectionForPushBack(id: string, reason: string): Promise<any> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/sections/${id}/pushback?reason=${encodeURIComponent(reason)}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async setSectionForRejection(id: string, reason: string): Promise<any> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/sections/${id}/reject?reason=${encodeURIComponent(reason)}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async setShaftForRejection(id: string, reason: string): Promise<any> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/shaft-assignments/${id}/reject?reason=${encodeURIComponent(reason)}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async setShaftForPushBack(id: string, reason: string): Promise<any> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/shaft-assignments/${id}/pushback?reason=${encodeURIComponent(reason)}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async rejectVehicle(id: string, reason: string): Promise<any> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/vehicles/${id}/reject?reason=${encodeURIComponent(reason)}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async pushBackVehicle(id: string, reason: string): Promise<any> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/vehicles/${id}/pushback?reason=${encodeURIComponent(reason)}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async registerDriver(driverData: {
    ...
    try {
      ...
      const response = await fetch('https://coappapi.commapp.online/api/drivers/register', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async registerVehicle(vehicleData: {
    ...
    try {
      ...
      const response = await fetch('https://coappapi.commapp.online/api/vehicles/register', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async fetchVehicles(): Promise<any[]> {
    try {
      ...
      const response = await fetch('https://coappapi.commapp.online/api/vehicles', {
        method: 'GET',
        headers: {
          'accept': '*/*',
  ...
  async fetchApprovedVehicles(): Promise<any[]> {
    try {
      ...
      const response = await fetch('https://coappapi.commapp.online/api/vehicles/status/approved', {
        method: 'GET',
        headers: {
          'accept': '*/*',
          ...(token ? { 'Authorization': `Bearer ${token}` } : {})
  ...
  async fetchApprovedDrivers(): Promise<any[]> {
    try {
      ...
      const response = await fetch('https://coappapi.commapp.online/api/drivers/status/approved', {
        method: 'GET',
        headers: {
          'accept': '*/*',
          ...(token ? { 'Authorization': `Bearer ${token}` } : {})
  ...
  async fetchVehicleById(vehicleId: string): Promise<any | null> {
    try {
      ...
      const response = await fetch(`https://coappapi.commapp.online/api/vehicles/${vehicleId}`, {
        method: 'GET',
        headers: {
          'Accept': '*/*',
          'Content-Type': 'application/json',
  ...
  async approveSecurityCompany(id: string): Promise<{ success: boolean; error?: string }> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/security-companies/${id}/approve`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async rejectSecurityCompany(id: string, reason: string): Promise<{ success: boolean; error?: string }> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/security-companies/${id}/reject?reason=${encodeURIComponent(reason)}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async pushBackSecurityCompany(id: string, reason: string): Promise<{ success: boolean; error?: string }> {
    ...
    try {
      return fetch(`https://coappapi.commapp.online/api/security-companies/${id}/pushback?reason=${encodeURIComponent(reason)}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async sendVehicleToMaintenance(vehicleId: string): Promise<{ success: boolean; error?: string }> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/vehicles/${vehicleId}/maintainance`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async updateOreTransportFields(oreId: string, fields: {
    ...
    try {
      ...
      const response = await fetch(`https://coappapi.commapp.online/api/ore-transports/${oreId}/fields?${queryParams.toString()}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': '*/*',
  ...
  async securityDispatchApprove(oreId: string): Promise<{ success: boolean; error?: string }> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/ore-transports/${oreId}/security-dispatcher/dispatched`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async securityRecievedApprove(oreId: string): Promise<{ success: boolean; error?: string }> {
    ...
    try {
      const response = await fetch(`https://coappapi.commapp.online/api/ore-transports/${oreId}/security-dispatcher/received`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  async assignMillToOre(
    ...
    try {
      const response = await fetch(
        `https://coappapi.commapp.online/api/ore-transports/${oreId}/mills/unknown?millid=${millId}&millName=${encodeURIComponent(millName)}&millType=${encodeURIComponent(millType)}&location=${encodeURIComponent(millLocation)}`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  async collectSample(
    ...
    try {
      ...
      const response = await fetch(
        `https://coappapi.commapp.online/api/ore-transports/${oreId}/collect-sample?${queryParams.toString()}`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  async updateSampleResults(
    ...
    try {
      ...
      const url = `https://coappapi.commapp.online/api/ore-transports/${oreId}/update-sample-if-default?${queryParams.toString()}`;
